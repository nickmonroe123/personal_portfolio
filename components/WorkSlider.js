            ...
            <SwiperSlide key={index}>
                <div className='grid grid-cols-2 grid-rows-2 gap-4 cursor-pointer'>
                    {slide.images.map((image, index)=> {
                        return (
                            <div className='relative rounded-lg overflow-hidden flex item-center justify-center group' key={image}>
                                <div className='flex items-cetner justify-center relative overflow-hidden
                                group key={index}'>
                                {/* image */}
                                ...
                                group-hover:xl:-translate-y-20 transition-all duration-300 text-[13px] tracking-[0.2em]'>
